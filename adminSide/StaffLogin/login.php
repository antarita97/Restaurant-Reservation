...
<body>
    ...
    <a class="nav-link" href="../../customerSide/home/home.php"> <h1 class="text-center" style="font-family:Copperplate; color:white;"> FLAVORISTA </h1><span class="sr-only"></span></a>
    ...
    <form action="login_process.php" method="post" >
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <button class="btn btn-light" onclick="goBack()"> Home </button>
            </div>

            <script>
                function goBack() {
                    window.location.href = "http://localhost/RestaurantProject-main/customerSide/home/home.php";
             }
            </script>
