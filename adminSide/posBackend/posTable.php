                ...
                <div class="row justify-content-center">
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        if ($reservationResult && mysqli_num_rows($reservationResult) > 0) {
                           ...
                           echo '<a href="#?bill_id=' . $latestBillID . '&table_id=' . $table_id . '"class="btn btn-primary btn-block btn-lg" style="color:black; '
                            ...
                            echo '<a href="#?bill_id=' . $latestBillID . '&table_id=' . $table_id . '"class="btn btn-primary btn-block btn-lg" '
