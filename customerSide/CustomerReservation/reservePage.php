...
<head>
    ...
    <style>
        body {
            ...
            color: white;
            padding-top: 56px; /* Offset to account for the fixed navbar */
            display: flex;
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="../home/home.php#hero" style="font-family: Copperplate;">FLAVORISTA</a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="../home/home.php#hero">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../CustomerReservation/reservePage.php">Reservation</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost/RestaurantProject-main/adminSide/StaffLogin/login.php">Staff</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <?php
        ...
        if ($reservationStatus === 'success') {
            ...
            echo '<script>
                ...
                setTimeout(function() { window.location.href = "../home/home.php"; }, 2000);
            </script>';
        }
    ...
    <div class="reserve-container">
        <a class="nav-link" href="../home/home.php#hero">
            <h1 class="text-center" style="font-family: Copperplate; color: whitesmoke;">FLAVORISTA</h1>
                        ...
                        <div class="form-group">
                            ...
                            <div id="availability-table">
                                ...
                                for ($hour = 10; $hour <= 20; $hour++) {
                                    $time = sprintf('%02d:%02d:00', $hour, 0);
                                    $availableTimes[] = $time;
                                }
                ...
                <div id="insert-reservation-into-table">
                    ...
                    <form id="reservation-form" method="POST" action="insertReservation.php">
                        ...
                        <div class="form-group mb-3">
                            <button type="submit" style="background-color: black; color: rgb(234, 234, 234);" class="btn" name="submit">Make Reservation</button>
                        </div>
                    </form>
                </div>
            </div>
