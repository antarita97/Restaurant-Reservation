  ...
  <section id="footer">
    <div class="footer container">
      ...
      <div class="sitemap"> <a href="../components/sitemap.html"> Sitemap </a></div>
      <p>© <?= date('Y') ?> Flavorista Restaurant </p>
...
.dropdown:hover .dropdown-content {
 ...
 .tooltip {
  ...
  background-color: cyan; /* Updated color */
  color: black;
  font-size: 20px;
  border: 2px solid white; /* Changed border color to match the dark theme */
  padding: 10px 20px;
  margin-top: 20px;
...
.sitemap a:hover {
  background-color: lightblue; /* Updated hover color for consistency */
  color: black;
  font-size: 24px;
