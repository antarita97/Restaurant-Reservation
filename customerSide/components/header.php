            ...
            <div class="nav-bar">
                <div class="brand">
                    <a class="nav-link" href="../home/home.php#hero">
                        <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;"> FLAVORISTA </h1><span
                            class="sr-only"></span>
                    </a>
                </div>
                <div class="nav-list">
...
?>
                                <li><a href="<?= strpos($current_url, "localhost/customerSide/home/home.php") !== false ? "#hero" : "/RestaurantProject-main/customerSide/home/home.php" ?>" data-after="Home">Home</a></li>
<?php
